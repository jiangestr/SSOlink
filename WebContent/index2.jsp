        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu waves-effect waves-dark" href="javascript:changePage('http://localhost:8092')"><i class="fa fa-dashboard"></i> 登陆</a>
                    </li>
                    <li>
                        <a href="javascript:changePage('http://localhost:8092/workflow/request/formbase.jsp?categoryid=297e899261111161016111e77562001a')" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> 表单</a>
                    </li>
					<li>
                        <a href="javascript:changePage('http://localhost:8092/workflow/request/workflow.jsp?&workflowid=297e89926106a01401610840115106ea')" class="waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i> 采购申请</a>
                    </li>
                    <li>
		...
		<div id="page-wrapper">
		  <div class="header"> 
            ...
            <div id="page-inner">
				...
				<iframe id="sss" src="http://localhost:8092/main/login.jsp" style="height: 900px;width: 100%"></iframe>
...
<script type="text/javascript">
            	...
            	{
            	 $("#sss").contents().find("#uname").val()= 'sysadmin';
            	$("#sss").contents().find("#j_password").html() = 'admin007';
            	alert($("#sss").contents().find("#uname").html());
